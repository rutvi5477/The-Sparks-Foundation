...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-8 mb-lg-0">
                    ...
                    <li class="nav-item py-3">
                        <a class="nav-link active" aria-current="page" href="money.php">Money Transfer</a>
                    </li>
                    <li class="nav-item py-3">
    ...
    <class class="welcome">
        <h2>
          <strong><i>Money
                Transfer</i></strong> <img src="logos/money transfer.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
