...
<class class="welcome">
        <h2>
           <strong><i>Transaction History </i></strong> <img
                src="logos/transac.png" alt="Transaction History" width="75" height="75">
        </h2>
    </class>
...
<!-- Table -->
    ...
    <table class="table table-hover table-striped">
        <thead style="color : blue;" class="table-danger">
            <tr>
...
<tr style="color : black;">
    ...
    <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            <!-- Copyright -->
            <div class="text-center py-0" style="background-color:grey;color:#2424ff">  
